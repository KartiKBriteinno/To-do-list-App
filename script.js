    ...
    function renderTodo(){
        ...
        sortedFuture.forEach(item => {
            ...
            <div class="box_body1">
                ...
                <div class="body_item4">
                    <img src="https://surjeet-todo-list.netlify.app/img/check-circle%201.png" alt="" class="complete" data-task-type="future" data-task-index-future="${futureid - 1}">
                    <img src="https://surjeet-todo-list.netlify.app/img/trash%201.png" alt="" class="delete" data-task-type="future" data-task-index-future="${futureid - 1}">
                </div>
            </div>
            `;
        });
